...
$acara = mysqli_query($mysqli, "SELECT a.nama, ra.id_acara , ra.status, ra.id_relawan_acara FROM relawan_acara ra JOIN acara a ON ra.id_acara = a.id_acara WHERE ra.id_relawan = '$id_relawan'");
$ac = mysqli_fetch_array($acara);
?>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <form action="set_relawan.php" method="post" enctype="multipart/form-data">
                                ...
                                Username: <br>
                                <?php echo $dr['username']; ?><br><br>
                                Email: <br>
                                <?php echo $dr['email']; ?><br><br>
                                Nomor Telepon: <br>
                                <?php echo $dr['no_hp']; ?><br><br>
                                Coba : <br>
                                Foto<br>
